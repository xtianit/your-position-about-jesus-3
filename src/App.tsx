...
const quizQuestions = [
    ...
    {
        q: "According to the lesson introduction, who cannot stumble?",
        a: [
            "Those who walk in the light",
            "Those who follow the Pharisees",
            "Those who are wealthy",
            "Those who attend the synagogue daily",
        ],
        correct: 0,
    },
    {
        q: "Which scriptures describe Jesus as the light?",
        a: [
            "John 1:9 and John 8:12",
            "Genesis 1:3 and Psalm 27:1",
            "Matthew 5:14 and Isaiah 60:1",
            "Luke 2:32 and Acts 13:47",
        ],
        correct: 0,
    },
    {
        q: "According to the lesson, what destroys the strong and mighty?",
        a: [
            "Ignorance",
            "Wealth",
            "Fasting",
    ...
    {
        q: "What preserves a believer according to the lesson?",
        a: [
            "Personal conviction",
            "Public recognition",
    ...
    {
        q: "According to the first lesson point, why do poor sinners and the tormented come quickly to Jesus?",
        a: [
            "Because Jesus fits perfectly into their needs",
            "Because they seek signs only",
            "Because they want to argue with Jesus",
            "Because they are compelled by the Pharisees",
        ],
        correct: 0,
    },
    {
        q: "Which scriptures show that Jesus fits into the needs of the broken and afflicted?",
        a: [
            "Isaiah 61:1-3 and Isaiah 53:4-5",
            "John 3:16 and Romans 8:1",
            "Psalm 103:1-5 and Hebrews 4:12",
            "Acts 1:8 and Matthew 28:19",
        ],
        correct: 0,
    },
    {
        q: "According to the lesson, to whom does God reveal things?",
        a: [
    ...
    {
        q: "Which scripture emphasizes that God hides things from the wise and reveals them to babes?",
        a: [
            "Matthew 11:25-26",
            "John 3:3",
            "Luke 12:48",
